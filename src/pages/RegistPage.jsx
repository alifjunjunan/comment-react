    ...
    return (
        <>
            <Box w={{ base: '80%', md: '70%' }} m='150px auto'>
                <Heading as='h3' size={{ base: 'sm', sm: 'lg' }} textAlign='center'>Register to YourDiary</Heading>
                <Box mt='25px' w='100%' borderRadius='10px' boxShadow='lg' maxHeight='500px'>
                    <Box padding={{ base: '20px 40px', md: '20px 100px' }}>
                        <FormControl mt='10px'>
                            <FormLabel id='fullname' fontSize={{ base: '11px', sm: '15px', md: '16px' }}>Full name</FormLabel>
                            <Input type='fullname' size={{ base: 'xs', sm: 'md' }} name='fullname' value={data.fullname} onChange={(event) => handleInput(event)} />
                        </FormControl>
                        <FormControl mt='10px'>
                        ...
                        <Button colorScheme='cyan' color='white' size={{ base: 'xs', sm: 'md' }} fontSize={{ base: '10px', md: '16px' }} mt='20px' w='100%' type='submit' onClick={handdleRegist}>Register</Button>
                        <Box mt='30px' display='flex' justifyContent='center'>
                            <Text fontSize={{ base: '11px', sm: '15px', md: '15px' }} mr='5px'>Already have an account?</Text>
